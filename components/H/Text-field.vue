  ...
  <div :class="mainDiv">
    ...
    >
      ...
      <input
        ...
        class="block w-full text-base text-gray-800 dark:bg-gray-700 dark:text-gray-300 placeholder-gray-300 dark:placeholder-secondary p-2 transition-all duration-300 rounded-md font-body focus:outline-none"
      ...
      >
        <Icon
          class="text-gray-500 dark:text-black"
